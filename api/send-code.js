  ...
  await transporter.sendMail({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:420px;margin:0 auto;padding:28px">
        ...
        <p style="color:#444;margin-bottom:20px">hakanefe.com portfolyo sitesine geri bildirim göndermek için kodunuz:</p>
        ...
        <p style="color:#999;font-size:0.85rem;margin-top:16px">Bu kod 10 dakika geçerlidir. Siz talep etmediyseniz bu e-postayı görmezden gelebilirsiniz.</p>
      </div>
    `,
  });
